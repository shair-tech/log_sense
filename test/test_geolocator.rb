...
class DataCruncherTest < Minitest::Test
  ...
  def test_geolocation
    ...
    parser = LogSense::Apache::LogParser.new
    ...
    assert_equal "United States of America", data[0][4], "Maybe GeoIp changed?"
    assert_equal "United States of America", data[1][4], "Maybe GeoIp changed?"
    assert_equal "Palestine, State of", data.last[4], "Maybe GeoIp changed?"
  end
end
